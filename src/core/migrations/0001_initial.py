    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "phone_number",
                    models.CharField(
                        blank=True, max_length=100, verbose_name="Número de teléfono"
                    ),
                ),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "document_number",
                    models.IntegerField(verbose_name="Número de documento"),
                ),
                (
                    "document_type",
                    models.CharField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "main_street",
                    models.CharField(max_length=250, verbose_name="Calle principal"),
                ),
                (
                    "secondary_stret",
                    models.CharField(max_length=250, verbose_name="Calle secundaria"),
                ),
                (
                    "reference",
                    models.CharField(max_length=250, verbose_name="Referencia"),
                ),
                (
                    "addrress_number",
                    models.CharField(max_length=50, verbose_name="Número de domicilio"),
                ),
                ("city", models.CharField(max_length=250, verbose_name="Ciudad")),
                ("country", models.CharField(max_length=250, verbose_name="Pais")),
                (
                    "province",
                    models.CharField(max_length=250, verbose_name="Provincia"),
                ),
                (
                    "contact",
                    models.ForeignKey(
